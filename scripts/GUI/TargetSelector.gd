...
func _ready():
	...
	get_node("base/TargetList").connect("OnSelectionChanged", self, "SelectionChanged_Callback")
...
func SelectionChanged_Callback():
	...
	for data in get_node("base/TargetList").Content:
...
func Init(init_param):
	...
	get_node("base/TargetList").Content = target_obj
